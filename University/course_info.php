...
if(isset($_GET['action'])) {
	...
	file_put_contents('xml/assign.xml', $users->asXML());
	}
	$users = simplexml_load_file('xml/assign.xml');
	
	$finfo= 'Teacher Information';
?>
<!DOCTYPE HTML>
<html lang="en">
		<head>
	...
	<h1><?php echo $finfo ?></h1>
		...
		<table class="content-table">
			...
			<tr>
				...
				<a href="course_info.php?action=delete&id=<?php echo $user['id']; ?>" onclick="return confirm('Do you want to delete?')"><button>Delete</button></a>
				</td>
